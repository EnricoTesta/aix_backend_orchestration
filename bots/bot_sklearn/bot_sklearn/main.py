...
def process(input_directory=None, output_directory=None):
    ...
    pickle_file_name = os.path.join(output_directory, 'logistic_regression_model.pkl')
...
def transform(input_directory=None, output_directory=None):
    ...
    trained_model_filename = os.path.join(input_directory, 'logistic_regression_model.pkl')
